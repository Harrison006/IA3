    ...
    children=[
        ...
        html.Div(
            [
                ...
                dcc.Input(
                    id="text-input-3", type="text", placeholder="Enter Patient ID..."
                ),
            ],
        ...
        html.Div(
            [
                ...
                dcc.Input(
                    id="clinician-input",
                    type="text",
                    placeholder="Clinician username...",
                ),
            ],
            className="input-container",
        ),
        ...
        html.Div(
            [
                ...
                dcc.Input(
                    id="hip-flexors-input", type="text", placeholder="Hip Flexors..."
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="knee-extensors-input",
                    type="text",
                    placeholder="Knee Extensors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="dorsiflexors-input", type="text", placeholder="Dorsiflexors..."
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="great-toe-extensor-input",
                    type="text",
                    placeholder="Great Toe Extensor...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="plantar-flexors-input",
                    type="text",
                    placeholder="Plantar Flexors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="shoulder-abductors-input",
                    type="text",
                    placeholder="Shoulder Abductors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="elbow-flexors-input",
                    type="text",
                    placeholder="Elbow Flexors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="elbow-extensors-input",
                    type="text",
                    placeholder="Elbow Extensors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="wrist-extensors-input",
                    type="text",
                    placeholder="Wrist Extensors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="finger-flexors-input",
                    type="text",
                    placeholder="Finger Flexors...",
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="hand-intrinsics-input",
                    type="text",
                    placeholder="Hand Intrinsics...",
                ),
            ],
            className="input-container",
        ),
        ...
        html.Div(
            [
                ...
                dcc.Input(
                    id="dysarthria-input", type="text", placeholder="Dysarthria..."
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="dysphonia-input", type="text", placeholder="Dysphonia..."
                ),
            ],
            className="input-container",
        ),
        ...
        html.Div(
            [
                ...
                dcc.Input(
                    id="attention-input", type="text", placeholder="Attention..."
                ),
            ],
            className="input-container",
        ),
        html.Div(
            [
                ...
                dcc.Input(
                    id="judgement-input", type="text", placeholder="Judgement..."
                ),
            ],
            className="input-container",
        ),
